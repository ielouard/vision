...
lib = CDLL("/home/guest_std08/darknet/libdarknet.so", RTLD_GLOBAL)
...
net = load_net("/home/guest_std08/darknet/cfg/yolov3-tiny.cfg", "/home/guest_std08/darknet/yolov3-tiny.weights", 0)
meta = load_meta("/home/guest_std08/darknet/cfg/coco.data")
while(True):
	...
	j=j+1
	#filename="/home/guest_std08/darknet/data/%s_%d.jpg" % (name, j-1)
